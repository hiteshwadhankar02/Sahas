   ...
   <br></br><br></br>
      <center><span style={{color:'red'}}>* If the updated receipt does not print, refresh the page</span></center>
        ...
        <div className='receipt_div shadow-lg mb-5 bg-body-tertiary rounded' style={{border:'solid 1px black', width:'800px', margin:'0 auto'}} >
            ...
            <div style={{display:'flex'}}>
                <div style={{marginLeft:'10%'}} >
                    ...
                    <span><b>Time  :</b></span>  <span id="time">Loading..</span> &nbsp;&nbsp;&nbsp;&nbsp; <span><b>Adm No : </b> ~</span><br></br>
                    <span><b>For</b></span> : <span id="for">Loading..</span>
                </div>
                    ...
                    <table style={{width:'80%', border:"1px solid black"}}> 
                        ...
                        <tbody>
                            <tr>
                                ...
                                <p>
                                    <strong><i class="fa fa-inr"></i> 2000/-</strong>
                                </p>
                                <p>
                            ...
                            <tr >
                                ...
                                <td class="text-left text-danger" style={{	padding: '9px 20px !important', fontSize: '13px', fontWeight: 'initial !important'}}><h2 style={{fontSize: '20px', fontWeight: "900", margin: '0', textTransform: 'uppercase'}}><strong><i class="fa fa-inr"></i> 3100/-</strong></h2></td>
                            </tr>
                        </tbody>
                    </table>
                        </div>
        ...
        <center>
            ...
            <Link to="/Dashboard"><button type="button" class="btn btn-primary">Dashboard</button> </Link>
        </center>
        <br></br><br></br>
    </>
  )
