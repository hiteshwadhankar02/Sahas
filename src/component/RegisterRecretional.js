 ...
 */
  ...
  // New code
      ...
      let fData = new FormData();
      fData.append('vid', vca);  //New Line Code
      fData.append('name', name);
      ...
      <br />
        <form>
          ...
          <div className="mb-3">
            ...
            <input type="number" className="form-control" id="vid" onChange={(e) => setVca(e.target.value)} />
          </div>
          <div className="mb-3">
          ...
          <div className="mb-3">
            ...
            <div className="input-group mb-3">
              <select className="form-select" id="inputGroupSelect01" value={Gage} onChange={(e) => setGage(e.target.value)}>
                ...
                <option value="Badminton">Under 17</option>
                <option value="Sketing">Under 15</option>
                <option value="Zumba">Under 13</option>
              </select>
            </div>
          </div>
          {/* New Code above */}
