...
export default function RegisterCoach({dbpath, setBtnstatus}) {
  ...
  const handleSendOtp = () => {
    ...
    if(email === 'omaltphone@gmail.com' || email === 'omkharche321@gmail.com' || email === 'hr.royalswebtechpvtltd@gmail.com' || email === 'prajyoturkude@gmail.com'|| email === 'ramtekeaman2002@gmail.com' || email === 'hiteshwadhankar12@gmail.com')
    {
      setEmail(email);
